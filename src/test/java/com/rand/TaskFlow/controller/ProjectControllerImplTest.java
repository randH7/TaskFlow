...
class ProjectControllerImplTest {
    ...
    public void setUp() throws ParseException {
        ...
        Project sampleProject1 = new Project("Sample Project", manager, leader, new java.sql.Date(dateFormat.parse("2024-10-10").getTime()), new java.sql.Date(dateFormat.parse("2025-10-10").getTime()), "description", IN_PROGRESS);
        Project sampleProject2 = new Project("Sample Project 2", manager, leader, new java.sql.Date(dateFormat.parse("2024-07-10").getTime()), new java.sql.Date(dateFormat.parse("2025-07-10").getTime()), "description 2", IN_PROGRESS);
    ...
    void post_Valid_CreatedProject() throws Exception {
        ...
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
        AddProjectDTO projectDTO = new AddProjectDTO("SDA web", "testUserTM",  new java.sql.Date(dateFormat.parse("2024-10-10").getTime()),  new java.sql.Date(dateFormat.parse("2024-10-15").getTime()), "SDA web.", "IN_PROGRESS", teamMembersUsername);
        ...
        MvcResult mvcResult = mockMvc.perform(post("/api/projects/create-project")
                        .content(body)
        ...
        assertTrue(mvcResult.getResponse().getContentAsString().contains("Project Created Successfully. Now Let's Start"));
    ...
    void patch_Valid_UpdatedProject() throws Exception {
        ...
        updatesProject.put("leaderUsername", "employ2");
        ...
        MvcResult mvcResult = mockMvc.perform(patch("/api/projects/edit-project/{projectId}", projectId)
                        .content(body)
                        .contentType(MediaType.APPLICATION_JSON)
        ...
        assertTrue(mvcResult.getResponse().getContentAsString().contains("Project Updated Successfully."));
        assertEquals("employ2", projectRepo.findTopByOrderByProjectIdDesc().getLeader().getUsername());
    }
    ...
    void delete_Valid_DeletedProject() throws Exception {
        ...
        MvcResult mvcResult = mockMvc.perform(delete("/api/projects/delete-project/{projectId}", projectId))
                .andExpect(status().isAccepted())
                .andExpect(MockMvcResultMatchers.content().contentType("text/plain;charset=UTF-8"))
                .andReturn();
