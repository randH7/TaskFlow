...
////        Manager manager = new Manager("testUser", "testUser@g.com", passwordEncoder.encode("12345"), "Rand", "manager", false, authoritiesM);
////        mangerRepo.save(manager);
////
////        Set<Role> authoritiesT = new HashSet<>();
////        authoritiesT.add(roleRepo.findByAuthority("ROLE_TEAM_MEMBER").get());
////        Employ employ1 = new Employ("employ1", "employ1@g.com", passwordEncoder.encode("12345"), "Ali", "developer", false, authoritiesT);
